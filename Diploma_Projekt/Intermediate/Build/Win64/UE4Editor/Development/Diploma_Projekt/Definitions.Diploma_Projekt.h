...
#define ORIGINAL_FILE_NAME "UE4Editor-Diploma_Projekt.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Diploma_Projekt
#define DEPRECATED_FORGAME DEPRECATED
#define DIPLOMA_PROJEKT_API DLLEXPORT
